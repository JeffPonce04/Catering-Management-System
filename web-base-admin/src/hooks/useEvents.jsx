// src/hooks/useEvents.js - FIXED with proper event types deduplication
...
export const useAssignStaff = () => {
    ...
    return useMutation({
        ...
        onSuccess: (response, { eventId }) => {
            message.success(response?.data?.message || 'Staff assigned and schedule created.');
...
export const useApproveSelectedEquipment = () => {
    const queryClient = useQueryClient();
    return useMutation({
...
export const useApproveAllEquipment = () => {
    const queryClient = useQueryClient();
    return useMutation({
...
export const useUpdateLiveStatus = () => {
    ...
    return useMutation({
        ...
        onSuccess: (response, { eventId }) => {
            ...
            queryClient.invalidateQueries({ queryKey: eventKeys.liveStatus(eventId), refetchType: 'active' });
            queryClient.invalidateQueries({ queryKey: eventKeys.detail(eventId), refetchType: 'active' });
            queryClient.invalidateQueries({ queryKey: ['bookings', 'list'], refetchType: 'active' });
        },
