...
export const normalizeAttendanceLog = (record = {}) => {
  ...
  return {
    ...
    selfie_url: record.selfie_url || record.time_in_selfie_url || record.time_out_selfie_url || record.time_in_photo || record.time_out_photo || null,
    location:
      record.location ||
  ...
  return records.flatMap((rawRecord) => {
    ...
    if (record.time_in) {
      events.push({
        ...
        selfie_url: record.time_in_selfie_url || record.time_in_photo || record.selfie_url,
        location:
          record.time_in_latitude != null && record.time_in_longitude != null
            ? { lat: Number(record.time_in_latitude), lng: Number(record.time_in_longitude) }
            : record.location,
    ...
    if (record.time_out) {
      events.push({
        ...
        selfie_url: record.time_out_selfie_url || record.time_out_photo || record.selfie_url,
        location:
          record.time_out_latitude != null && record.time_out_longitude != null
            ? { lat: Number(record.time_out_latitude), lng: Number(record.time_out_longitude) }
            : record.location,
